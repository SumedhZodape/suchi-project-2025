...
export const getAllDropdowns = async (req, res) => {
  try {
    ...
    const DAYITVA_MASTER_ORDER = [
      ...
      "सह क्षेत्र प्रचारक प्रमुख",
      "क्षेत्र शारीरिक प्रमुख",
      "सह क्षेत्र शारीरिक प्रमुख",
      "क्षेत्र बौद्धिक प्रमुख",
      "सह क्षेत्र बौद्धिक प्रमुख",
      "क्षेत्र व्यवस्था प्रमुख",
      "क्षेत्र सह व्यवस्था प्रमुख",
      "सह क्षेत्र व्यवस्था प्रमुख",
      "क्षेत्र सेवा प्रमुख",
      "सह क्षेत्र सेवा प्रमुख",
      "क्षेत्र संपर्क प्रमुख",
      "सह क्षेत्र संपर्क प्रमुख",
    ...
    const KSHETRA_ORDER = [
      ...
      "उत्तर क्षेत्र",
      "पश्चिम उत्तरप्रदेश क्षेत्र",
      "पूर्वी उत्तरप्रदेश क्षेत्र",
      "उत्तर पूर्व क्षेत्र",
      "पूर्व क्षेत्र",
      "असम क्षेत्र",
      "नेपाल",
    ...
    const SANGHATAN_ORDER = [
      ...
      "सीमा जागरण",
      "हिंदु जागरण मंच",
      "पूर्व सैनिक से परिषद"
    ];

    /* ===========================================================
       FETCH DATA (MATCHING SCHEMAS)
    =========================================================== */

    const stars = await Star.find().select("name active");
    ...
    const sortByOrder = (items, order) => {
      ...
      return items.sort(
        (a, b) =>
          (map.get(a.name) ?? Infinity) -
          (map.get(b.name) ?? Infinity)
      );
    };
    ...
    res.status(200).json({
      stars: sortByOrder(stars, STAR_ORDER),
      prakars,
      sanghatans: sortByOrder(sanghatans, SANGHATAN_ORDER),
      dayitvas: sortByOrder(dayitvas, DAYITVA_MASTER_ORDER),
      kshetras: sortByOrder(kshetras, KSHETRA_ORDER),
      prants: sortByOrder(prants, PRANT_ORDER)
    });
